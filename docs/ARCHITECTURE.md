...
| AD-9 | Ruleset baseline: nyc.v2.4 (corrected subset), schema popengine-rules/v2 | Adopted 2026-07-22 after two fetch-confirmed verification passes; the 59-rule draft in `rules/proposals/` is the post-capstone target. |
