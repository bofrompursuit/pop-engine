...
- **Dev 1 — Rules engine + verdict:** F-201, F-102; owns engine fidelity to `rules/nyc-rules.v2.5.json` and the fixture suite. Verify: full fixture suite (scenarios + boundaries) passes as automated tests.
