...
|---|---|---|---|
| Product requirements | `docs/PRD.md` | APPROVED (reconciled to nyc.v2.2, 2026-07-22) | — |
...
| **Current NYC ruleset** | `rules/nyc-rules.v2.2.json` (nyc.v2.2) | **APPROVED** (team ratification 2026-07-22; republished as v2.2 on 2026-07-25) | per-fact promotion SOURCE_CONFIRMED → VERIFIED continues during the build (verification issue; OPEN-QUESTIONS §2) |
