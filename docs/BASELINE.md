...
| **Scenario fixtures** | `docs/test-scenario-answer-key.md` (v4) | **APPROVED** — v3 team-ratified 2026-07-22 with the ruleset; v4 authorized by the product owner 2026-07-25 | now the green-gate acceptance suite; v4 states six intake facts the fixtures already evaluated on (battery, structures, generator, flame, F's vendor count) and moves no expected output |
